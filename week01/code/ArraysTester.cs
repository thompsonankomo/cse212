public static class ArraysTester
{
    ...
    /// <summary>
    /// This function produces a list of size 'length' starting with 'number' followed by multiples of 'number'.  For 
    /// example, MultiplesOf(7, 5) will result in: {7, 14, 21, 28, 35}.  Assuming that  the length is a positive
